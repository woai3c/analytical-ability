      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_320px]">
        <Card>
          ...
          <CardContent className="p-6">
            <blockquote className="rounded-lg border-l-2 border-[var(--border-strong)] bg-muted p-5 text-base font-medium leading-7">
              {t('“只要我每周投入 10 小时，就一定能在六个月内成功转行。”')}
            </blockquote>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t('与目标分析的连接')}</CardTitle>
            </CardHeader>
            <CardContent className="text-xs leading-6 text-muted-foreground">
              {t('完成一次真实目标后，系统会从你修改最多、遗漏最多的环节生成下一道题，并把训练结果写回能力档案。')}
            </CardContent>
          </Card>
        </div>
      </div>
